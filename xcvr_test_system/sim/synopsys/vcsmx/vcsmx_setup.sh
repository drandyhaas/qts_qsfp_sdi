...
# ACDS 23.3 104 linux 2023.10.17.11:13:42
...
# ----------------------------------------
# If xcvr_test_system is one of several IP cores in your
...
TOP_LEVEL_NAME="xcvr_test_system.xcvr_test_system"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [xcvr_test_system::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [xcvr_test_system::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [xcvr_test_system::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [xcvr_test_system::get_dpi_libraries "$QSYS_SIMDIR"]]
