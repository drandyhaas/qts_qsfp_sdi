// q_sys_altera_mm_interconnect_1920_57nh4yy.v
...
`timescale 1 ps / 1 ps
module q_sys_altera_mm_interconnect_1920_57nh4yy (
	...
	wire    [9:0] cmd_demux_src7_channel;                                             // cmd_demux:src7_channel -> crosser:in_channel
	...
	wire    [9:0] cmd_demux_src8_channel;                                             // cmd_demux:src8_channel -> crosser_001:in_channel
	...
	wire    [9:0] cmd_demux_src9_channel;                                             // cmd_demux:src9_channel -> crosser_002:in_channel
	...
	wire  [129:0] rsp_demux_007_src0_data;                                            // rsp_demux_007:src0_data -> crosser_003:in_data
	wire          rsp_demux_007_src0_ready;                                           // crosser_003:in_ready -> rsp_demux_007:src0_ready
	wire    [9:0] rsp_demux_007_src0_channel;                                         // rsp_demux_007:src0_channel -> crosser_003:in_channel
	...
	wire  [129:0] rsp_demux_008_src0_data;                                            // rsp_demux_008:src0_data -> crosser_004:in_data
	wire          rsp_demux_008_src0_ready;                                           // crosser_004:in_ready -> rsp_demux_008:src0_ready
	wire    [9:0] rsp_demux_008_src0_channel;                                         // rsp_demux_008:src0_channel -> crosser_004:in_channel
	...
	wire          rsp_demux_009_src0_valid;                                           // rsp_demux_009:src0_valid -> crosser_005:in_valid
	wire  [129:0] rsp_demux_009_src0_data;                                            // rsp_demux_009:src0_data -> crosser_005:in_data
	wire          rsp_demux_009_src0_ready;                                           // crosser_005:in_ready -> rsp_demux_009:src0_ready
	wire    [9:0] rsp_demux_009_src0_channel;                                         // rsp_demux_009:src0_channel -> crosser_005:in_channel
	wire          rsp_demux_009_src0_startofpacket;                                   // rsp_demux_009:src0_startofpacket -> crosser_005:in_startofpacket
	wire          rsp_demux_009_src0_endofpacket;                                     // rsp_demux_009:src0_endofpacket -> crosser_005:in_endofpacket
	...
	wire    [9:0] master_0_master_limiter_cmd_src_channel;                            // master_0_master_limiter:cmd_src_channel -> limiter_pipeline:in_channel
	...
	wire    [9:0] limiter_pipeline_001_source0_channel;                               // limiter_pipeline_001:out_channel -> master_0_master_limiter:rsp_sink_channel
	...
	wire    [9:0] agent_pipeline_source0_channel;                                     // agent_pipeline:out_channel -> product_info_0_avalon_slave_0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_002_source0_channel;                                 // agent_pipeline_002:out_channel -> qsfp_xcvr_test_0_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_004_source0_channel;                                 // agent_pipeline_004:out_channel -> qsfp_xcvr_test_1_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_006_source0_channel;                                 // agent_pipeline_006:out_channel -> qsfp_xcvr_test_3_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_008_source0_channel;                                 // agent_pipeline_008:out_channel -> qsfp_xcvr_test_4_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_010_source0_channel;                                 // agent_pipeline_010:out_channel -> sdi_xcvr_test_0_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_012_source0_channel;                                 // agent_pipeline_012:out_channel -> sdi_xcvr_test_1_mm_bridge_0_s0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_014_source0_channel;                                 // agent_pipeline_014:out_channel -> sdi_xcvr_atx_pll_reconfig_avmm0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_016_source0_channel;                                 // agent_pipeline_016:out_channel -> qsfp_xcvr_atx_pll_reconfig_avmm0_agent:cp_channel
	...
	wire    [9:0] agent_pipeline_018_source0_channel;                                 // agent_pipeline_018:out_channel -> qsfp_xcvr_atx_pll1_reconfig_avmm0_agent:cp_channel
	...
	wire    [9:0] crosser_out_channel;                                                // crosser:out_channel -> mux_pipeline_007:in_channel
	...
	wire    [9:0] crosser_001_out_channel;                                            // crosser_001:out_channel -> mux_pipeline_008:in_channel
	...
	wire    [9:0] crosser_002_out_channel;                                            // crosser_002:out_channel -> mux_pipeline_009:in_channel
	...
	wire  [129:0] rsp_demux_src0_data;                                                // rsp_demux:src0_data -> mux_pipeline_010:in_data
	...
	wire  [129:0] mux_pipeline_010_source0_data;                                      // mux_pipeline_010:out_data -> rsp_mux:sink0_data
	...
	wire  [129:0] rsp_demux_001_src0_data;                                            // rsp_demux_001:src0_data -> mux_pipeline_011:in_data
	...
	wire  [129:0] mux_pipeline_011_source0_data;                                      // mux_pipeline_011:out_data -> rsp_mux:sink1_data
	...
	wire  [129:0] rsp_demux_002_src0_data;                                            // rsp_demux_002:src0_data -> mux_pipeline_012:in_data
	...
	wire  [129:0] mux_pipeline_012_source0_data;                                      // mux_pipeline_012:out_data -> rsp_mux:sink2_data
	...
	wire  [129:0] rsp_demux_003_src0_data;                                            // rsp_demux_003:src0_data -> mux_pipeline_013:in_data
	...
	wire  [129:0] mux_pipeline_013_source0_data;                                      // mux_pipeline_013:out_data -> rsp_mux:sink3_data
	...
	wire  [129:0] rsp_demux_004_src0_data;                                            // rsp_demux_004:src0_data -> mux_pipeline_014:in_data
	...
	wire  [129:0] mux_pipeline_014_source0_data;                                      // mux_pipeline_014:out_data -> rsp_mux:sink4_data
	...
	wire  [129:0] rsp_demux_005_src0_data;                                            // rsp_demux_005:src0_data -> mux_pipeline_015:in_data
	...
	wire  [129:0] mux_pipeline_015_source0_data;                                      // mux_pipeline_015:out_data -> rsp_mux:sink5_data
	...
	wire  [129:0] rsp_demux_006_src0_data;                                            // rsp_demux_006:src0_data -> mux_pipeline_016:in_data
	...
	wire  [129:0] mux_pipeline_016_source0_data;                                      // mux_pipeline_016:out_data -> rsp_mux:sink6_data
	...
	wire  [129:0] crosser_003_out_data;                                               // crosser_003:out_data -> mux_pipeline_017:in_data
	wire          crosser_003_out_ready;                                              // mux_pipeline_017:in_ready -> crosser_003:out_ready
	wire    [9:0] crosser_003_out_channel;                                            // crosser_003:out_channel -> mux_pipeline_017:in_channel
	...
	wire  [129:0] mux_pipeline_017_source0_data;                                      // mux_pipeline_017:out_data -> rsp_mux:sink7_data
	...
	wire    [9:0] crosser_004_out_channel;                                            // crosser_004:out_channel -> mux_pipeline_018:in_channel
	...
	wire  [129:0] mux_pipeline_018_source0_data;                                      // mux_pipeline_018:out_data -> rsp_mux:sink8_data
	...
	wire    [9:0] crosser_005_out_channel;                                            // crosser_005:out_channel -> mux_pipeline_019:in_channel
	...
	wire  [129:0] mux_pipeline_019_source0_data;                                      // mux_pipeline_019:out_data -> rsp_mux:sink9_data
	...
	q_sys_altera_merlin_master_agent_1921_2inlndi #(
		...
		.rp_channel            (master_0_master_limiter_rsp_src_channel),                            //   input,   width = 10,          .channel
	...
	q_sys_altera_merlin_router_1921_lnketcy router (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_001 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_002 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_003 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_004 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_005 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_006 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_007 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_008 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_009 (
	...
	q_sys_altera_merlin_router_1921_ww4g4ya router_010 (
	...
	q_sys_altera_merlin_traffic_limiter_191_kcba44q #(
		...
		.cmd_src_channel        (master_0_master_limiter_cmd_src_channel),          //  output,   width = 10,          .channel
		...
		.rsp_src_channel        (master_0_master_limiter_rsp_src_channel),          //  output,   width = 10,          .channel
	...
	q_sys_altera_merlin_demultiplexer_1921_tbc4z7i cmd_demux (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_001 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_002 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_004 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_005 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_006 (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_007 (
		.clk                 (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_008 (
		.clk                 (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_2wwphby cmd_mux_009 (
		.clk                 (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset               (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_001 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_002 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_003 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_004 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_005 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_006 (
		.clk                (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset              (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_007 (
		.clk                (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_008 (
		.clk                (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_demultiplexer_1921_457fupy rsp_demux_009 (
		.clk                (clk_100_clk_clk),                                              //   input,    width = 1,       clk.clk
		.reset              (sdi_xcvr_atx_pll_reconfig_reset0_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	q_sys_altera_merlin_multiplexer_1922_veanixq rsp_mux (
		.clk                 (clk_50_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset               (product_info_0_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_data          (mux_pipeline_011_source0_data),                    //   input,  width = 130,          .data
		...
		.sink2_data          (mux_pipeline_012_source0_data),                    //   input,  width = 130,          .data
		...
		.sink3_data          (mux_pipeline_013_source0_data),                    //   input,  width = 130,          .data
		...
		.sink4_data          (mux_pipeline_014_source0_data),                    //   input,  width = 130,          .data
		...
		.sink5_data          (mux_pipeline_015_source0_data),                    //   input,  width = 130,          .data
		...
		.sink6_data          (mux_pipeline_016_source0_data),                    //   input,  width = 130,          .data
		...
		.sink7_data          (mux_pipeline_017_source0_data),                    //   input,  width = 130,          .data
		...
		.sink8_data          (mux_pipeline_018_source0_data),                    //   input,  width = 130,          .data
		...
		.sink9_data          (mux_pipeline_019_source0_data),                    //   input,  width = 130,          .data
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_out_channel),                                          //  output,   width = 10,              .channel
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_001_out_channel),                                      //  output,   width = 10,              .channel
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_002_out_channel),                                      //  output,   width = 10,              .channel
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_003_out_channel),                                      //  output,   width = 10,              .channel
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_004_out_channel),                                      //  output,   width = 10,              .channel
	...
	q_sys_hs_clk_xer_1940_suurwgi #(
		...
		.out_channel       (crosser_005_out_channel),                                      //  output,   width = 10,              .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (master_0_master_limiter_cmd_src_channel),          //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_out_channel),                                          //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_001_out_channel),                                      //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_002_out_channel),                                      //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_003_out_channel),                          //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_004_out_channel),                          //   input,   width = 10,          .channel
	...
	q_sys_altera_avalon_st_pipeline_stage_1930_bv2ucky #(
		...
		.in_channel        (crosser_005_out_channel),                          //   input,   width = 10,          .channel
