...
# ACDS 23.3 104 linux 2023.10.17.11:14:00
...
TOP_LEVEL_NAME="q_sys.q_sys"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/nfs/site/disks/swbld_archive_4/acds/23.3/104/linux64/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [q_sys::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [q_sys::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [q_sys::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [q_sys::get_design_libraries]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [q_sys::get_memory_files "$QSYS_SIMDIR"]]
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms_ncrypt.sv"            -work fourteennm_hssi    
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms_ncrypt.sv"             -work fourteennm_hssi    
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_components.vhd"             -work fourteennm_hssi    
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hssi_atoms.vhd"                  -work fourteennm_hssi    
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_components.vhd"              -work fourteennm_hssi    
  vhdlan $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                   "$QUARTUS_INSTALL_DIR/eda/sim_lib/ct1_hip_atoms.vhd"                   -work fourteennm_hssi    
fi
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [q_sys::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [q_sys::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [q_sys::get_dpi_libraries "$QSYS_SIMDIR"]]
