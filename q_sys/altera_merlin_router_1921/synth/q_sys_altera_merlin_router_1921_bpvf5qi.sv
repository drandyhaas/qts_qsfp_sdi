...
//    output_name             q_sys_altera_merlin_router_1921_bpvf5qi
//    pkt_addr_h              67
//    pkt_addr_l              36
//    pkt_dest_id_h           92
//    pkt_dest_id_l           90
...
//    pkt_trans_read          71
//    pkt_trans_write         70
//    slaves_info             0:0000001:0x0:0x10:read:1:0:0:1,3:0000010:0x10000:0x18000:both:1:0:0:1,4:0000100:0x20000:0x28000:both:1:0:0:1,5:0001000:0x30000:0x38000:both:1:0:0:1,6:0010000:0x40000:0x48000:both:1:0:0:1,2:0100000:0x100000:0x102000:both:1:0:0:1,1:1000000:0x200000:0x202000:both:1:0:0:1
//    st_channel_w            7
//    st_data_w               128
// ------------------------------------------

module q_sys_altera_merlin_router_1921_bpvf5qi_default_decode
  #(
...
module q_sys_altera_merlin_router_1921_bpvf5qi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    q_sys_altera_merlin_router_1921_bpvf5qi_default_decode the_default_decode(
    ...
    always @* begin
        ...
        // slave 5: [0x100000, 0x102000) : sel [21:13]
        if ( {address[21:13],{13 {1'b0}}} == 22'h100000   ) begin
            src_channel = 7'b0100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
        end

        // slave 6: [0x200000, 0x202000) : sel [21:13]
