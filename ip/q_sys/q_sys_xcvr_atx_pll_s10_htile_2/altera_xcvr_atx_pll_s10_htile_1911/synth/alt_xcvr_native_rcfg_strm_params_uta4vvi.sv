...
package alt_xcvr_native_rcfg_strm_params_uta4vvi;

  localparam rom_data_width = 27; // ROM data width 
  localparam rom_depth = 12; // Depth of reconfiguration rom
  localparam rcfg_cfg_depths = "6,6"; // Depths of individual configuration profiles in rom

  // Reconfiguration rom containing all profiles in order
  localparam reg [26:0] config_rom [0:11] = '{
    27'h001021F0C,
    27'h001054000,
    27'h001080701,
    27'h00109FF08,
