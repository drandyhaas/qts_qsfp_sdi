...
import alt_xcvr_native_rcfg_strm_params_klcbdna::*;

module alt_xcvr_native_rcfg_strm_top_klcbdna #(
  ...
  alt_xcvr_native_rcfg_strm_rom_klcbdna #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_klcbdna #(
