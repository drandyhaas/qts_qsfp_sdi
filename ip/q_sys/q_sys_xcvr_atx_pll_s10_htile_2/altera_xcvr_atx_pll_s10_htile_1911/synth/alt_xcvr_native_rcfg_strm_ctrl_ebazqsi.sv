...
module alt_xcvr_native_rcfg_strm_ctrl_ebazqsi #(
  ...
  // User Interface
  //--------------------------------------
  input  wire [31:0]                                              if_sel,      //Select one of the interfaces- this is 32 bits bc altera_xcvr_functions passes this down as an int
  ...
  generate
    if (xcvr_rcfg_shared) begin
      ...
      assign xcvr_reconfig_address = {if_sel[altera_xcvr_native_s10_functions_h::clogb2_alt_xcvr_native_s10(xcvr_rcfg_interfaces-1)-1:0],reconfig_address};
