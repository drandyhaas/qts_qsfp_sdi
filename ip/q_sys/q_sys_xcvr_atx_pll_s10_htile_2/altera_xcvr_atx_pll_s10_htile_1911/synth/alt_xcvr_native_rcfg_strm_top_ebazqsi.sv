...
import alt_xcvr_native_rcfg_strm_params_ebazqsi::*;

module alt_xcvr_native_rcfg_strm_top_ebazqsi #(
  ...
  alt_xcvr_native_rcfg_strm_rom_ebazqsi #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_ebazqsi #(
