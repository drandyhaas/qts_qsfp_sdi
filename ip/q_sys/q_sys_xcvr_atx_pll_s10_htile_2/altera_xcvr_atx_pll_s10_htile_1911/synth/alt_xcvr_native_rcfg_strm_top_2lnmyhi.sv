...
import alt_xcvr_native_rcfg_strm_params_2lnmyhi::*;

module alt_xcvr_native_rcfg_strm_top_2lnmyhi #(
  ...
  alt_xcvr_native_rcfg_strm_rom_2lnmyhi #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_2lnmyhi #(
