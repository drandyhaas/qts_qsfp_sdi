...
import alt_xcvr_native_rcfg_strm_params_3lxuczy::*;

module alt_xcvr_native_rcfg_strm_top_3lxuczy #(
  ...
  alt_xcvr_native_rcfg_strm_rom_3lxuczy #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_3lxuczy #(
