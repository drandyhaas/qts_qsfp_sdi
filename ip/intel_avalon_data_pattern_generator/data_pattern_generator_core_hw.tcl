...
# +-----------------------------------
# | module data_pattern_generator_core
# | 
set_module_property DESCRIPTION "Data Pattern Generator Core"
set_module_property NAME data_pattern_generator_core 
set_module_property VERSION  1.0
set_module_property INTERNAL true 
set_module_property AUTHOR "Intel Corporation"
set_module_property DISPLAY_NAME "Data Pattern Generator core"
set_module_property TOP_LEVEL_HDL_FILE data_pattern_generator.v 
set_module_property TOP_LEVEL_HDL_MODULE data_pattern_generator
...
# | files
# | 
add_file data_pattern_generator.v {SYNTHESIS SIMULATION}
add_file reset_controller.v {SYNTHESIS SIMULATION}
add_file reset_synchronizer.v {SYNTHESIS SIMULATION}
add_file data_pattern_generator.sdc SDC
add_file reset_controller.sdc SDC
# | 
# +-----------------------------------
...
set_parameter_property FREQ_CNTER_ENABLED IS_HDL_PARAMETER ture 
# | 
# +-----------------------------------
...
proc elaborate {} {
    ...
    if { $avalon == "true" } {
        ...
        add_interface_port pattern_out_clk aso_clk clk Input 1
        set_interface_property pattern_out_clk ENABLED $avalon

        #pattern in avalon mode
        ...
        add_interface_port conduit_pattern_out_clk aso_clk export Input 1
        #data conduit mode 
        ...
        #set_interface_property conduit_pattern_out associatedClock conduit_pattern_out_clk 
    }

    if { $avalon_input == "true" } {
        #clk avalon mode
        add_interface pattern_in_clk clock start
        add_interface_port pattern_in_clk asi_clk clk output 1
    ...
    if { $conduit_input == "true"} {
        #clk out conduit mode
        add_interface conduit_pattern_in_clk conduit end 
        add_interface_port conduit_pattern_in_clk asi_clk export Output 1
        ...
        #set_interface_property conduit_pattern_in associatedClock conduit_pattern_in_clk 
