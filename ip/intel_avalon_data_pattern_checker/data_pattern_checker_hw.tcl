...
# +-----------------------------------
# | module data_pattern_checker
# | 
set_module_property DESCRIPTION "Data Pattern Checker"
set_module_property NAME data_pattern_checker
set_module_property VERSION 1.0 
set_module_property AUTHOR "Intel Corporation"
set_module_property DISPLAY_NAME "Data Pattern Checker"
...
# Checker instance 
# +-----------------------------------
add_instance "data_pattern_checker" data_pattern_checker_core
...
proc composition { } {
    ...
    if { $avalon == "true" } {
        ...
        set_interface_assignment pattern_in debug.controlledBy csr_slave
    } else {
        ...
        set_interface_assignment conduit_pattern_in debug.controlledBy csr_slave
    }
