...
import alt_xcvr_native_rcfg_strm_params_jvmsdma::*;

module alt_xcvr_native_rcfg_strm_top_jvmsdma #(
  ...
  alt_xcvr_native_rcfg_strm_rom_jvmsdma #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_jvmsdma #(
