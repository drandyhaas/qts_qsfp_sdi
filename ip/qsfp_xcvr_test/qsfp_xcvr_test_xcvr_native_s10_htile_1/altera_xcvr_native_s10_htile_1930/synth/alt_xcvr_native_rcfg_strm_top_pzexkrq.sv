...
import alt_xcvr_native_rcfg_strm_params_pzexkrq::*;

module alt_xcvr_native_rcfg_strm_top_pzexkrq #(
  ...
  alt_xcvr_native_rcfg_strm_rom_pzexkrq #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_pzexkrq #(
