...
import alt_xcvr_native_rcfg_strm_params_utxzjjq::*;

module alt_xcvr_native_rcfg_strm_top_utxzjjq #(
  ...
  alt_xcvr_native_rcfg_strm_rom_utxzjjq #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_utxzjjq #(
