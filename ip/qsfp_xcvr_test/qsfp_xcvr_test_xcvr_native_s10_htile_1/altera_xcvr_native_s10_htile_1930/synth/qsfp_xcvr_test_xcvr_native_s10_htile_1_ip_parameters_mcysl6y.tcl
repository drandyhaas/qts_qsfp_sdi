...
dict set native_phy_ip_params profile_cnt "3"
set ::GLOBAL_corename qsfp_xcvr_test_xcvr_native_s10_htile_1_altera_xcvr_native_s10_htile_1930_mcysl6y
# ------------------------------- #
# --- Profile0 settings       --- #
# ------------------------------- #
...
dict set native_phy_ip_params set_data_rate_profile1 "25650.6"
...
# --- Profile2 settings       --- #
# ------------------------------- #
dict set native_phy_ip_params channels_profile2 "1"
dict set native_phy_ip_params set_data_rate_profile2 "9618.96"
dict set native_phy_ip_params bonded_mode_profile2 "not_bonded"
dict set native_phy_ip_params rcfg_enable_profile2 "1"
dict set native_phy_ip_params set_prbs_soft_logic_enable_profile2 "1"
dict set native_phy_ip_params std_pcs_pma_width_profile2 "10"
dict set native_phy_ip_params enh_pcs_pma_width_profile2 "64"
dict set native_phy_ip_params pcs_direct_width_profile2 "8"
dict set native_phy_ip_params protocol_mode_profile2 "basic_enh"
dict set native_phy_ip_params tx_fifo_mode_profile2 "Phase compensation"
dict set native_phy_ip_params rx_fifo_mode_profile2 "Phase compensation"
dict set native_phy_ip_params std_tx_byte_ser_mode_profile2 "Disabled"
dict set native_phy_ip_params std_rx_byte_deser_mode_profile2 "Disabled"
dict set native_phy_ip_params duplex_mode_profile2 "duplex"
dict set native_phy_ip_params enable_hip_profile2 "0"
dict set native_phy_ip_params tx_clkout_sel_profile2 "pcs_clkout"
dict set native_phy_ip_params rx_clkout_sel_profile2 "pcs_clkout"
dict set native_phy_ip_params enable_port_tx_clkout2_profile2 "1"
dict set native_phy_ip_params enable_port_rx_clkout2_profile2 "1"
dict set native_phy_ip_params tx_clkout2_sel_profile2 "pma_div_clkout"
dict set native_phy_ip_params rx_clkout2_sel_profile2 "pma_div_clkout"
dict set native_phy_ip_params tx_pma_div_clkout_divider_profile2 "2"
dict set native_phy_ip_params rx_pma_div_clkout_divider_profile2 "2"
dict set native_phy_ip_params l_tx_fifo_transfer_mode_profile2 "x2"
dict set native_phy_ip_params l_rx_fifo_transfer_mode_profile2 "x2"
dict set native_phy_ip_params datapath_select_profile2 "Enhanced"
dict set native_phy_ip_params tx_enable_profile2 "1"
dict set native_phy_ip_params rx_enable_profile2 "1"
