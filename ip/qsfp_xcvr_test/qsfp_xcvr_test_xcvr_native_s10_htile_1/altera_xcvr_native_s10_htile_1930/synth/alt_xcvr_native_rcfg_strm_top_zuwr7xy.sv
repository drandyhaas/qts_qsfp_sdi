...
import alt_xcvr_native_rcfg_strm_params_zuwr7xy::*;

module alt_xcvr_native_rcfg_strm_top_zuwr7xy #(
  ...
  alt_xcvr_native_rcfg_strm_rom_zuwr7xy #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_zuwr7xy #(
