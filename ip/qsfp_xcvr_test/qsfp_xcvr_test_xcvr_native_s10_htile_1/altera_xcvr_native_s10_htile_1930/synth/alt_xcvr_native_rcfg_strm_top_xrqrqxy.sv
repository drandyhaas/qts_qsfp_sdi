...
import alt_xcvr_native_rcfg_strm_params_xrqrqxy::*;

module alt_xcvr_native_rcfg_strm_top_xrqrqxy #(
  ...
  alt_xcvr_native_rcfg_strm_rom_xrqrqxy #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_xrqrqxy #(
