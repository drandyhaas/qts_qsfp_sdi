...
import alt_xcvr_native_rcfg_strm_params_mcysl6y::*;

module alt_xcvr_native_rcfg_strm_top_mcysl6y #(
  ...
  alt_xcvr_native_rcfg_strm_rom_mcysl6y #(
  ...
  alt_xcvr_native_rcfg_strm_ctrl_mcysl6y #(
