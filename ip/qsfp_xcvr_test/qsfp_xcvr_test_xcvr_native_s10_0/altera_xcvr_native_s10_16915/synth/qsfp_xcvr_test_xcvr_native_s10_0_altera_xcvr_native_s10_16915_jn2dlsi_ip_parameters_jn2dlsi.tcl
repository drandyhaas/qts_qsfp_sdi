...
set ::GLOBAL_corename qsfp_xcvr_test_xcvr_native_s10_0_altera_xcvr_native_s10_16915_jn2dlsi
# -------------------------------- #
# --- Default Profile settings --- #
# -------------------------------- #
dict set native_phy_ip_params set_data_rate_profile0 "17080.078125"
...
dict set native_phy_ip_params l_tx_transfer_clk_hz_profile0 "533752440"
dict set native_phy_ip_params l_rx_transfer_clk_hz_profile0 "533752440"
dict set native_phy_ip_params tx_pma_div_clkout_divider_profile0 "1"
dict set native_phy_ip_params rx_pma_div_clkout_divider_profile0 "0"
dict set native_phy_ip_params tx_coreclkin_clock_network_profile0 "dedicated"
dict set native_phy_ip_params rx_coreclkin_clock_network_profile0 "dedicated"
dict set native_phy_ip_params tx_coreclkin_freq_profile0 "156.25"