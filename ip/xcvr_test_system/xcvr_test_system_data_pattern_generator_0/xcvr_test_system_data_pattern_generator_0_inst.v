	xcvr_test_system_data_pattern_generator_0 u0 (
		...
		.conduit_pattern_out_clk_export (_connected_to_conduit_pattern_out_clk_export_), //   input,    width = 1, conduit_pattern_out_clk.export
		.aso_data                       (_connected_to_aso_data_)                        //  output,  width = 128,     conduit_pattern_out.export
	);
