...
# ACDS 23.3 104 linux 2023.10.17.11:13:43
...
# ----------------------------------------
# If qsfp_xcvr_test is one of several IP cores in your
...
TOP_LEVEL_NAME="qsfp_xcvr_test.qsfp_xcvr_test"
QSYS_SIMDIR="./../../"
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set memory_files [concat $memory_files [qsfp_xcvr_test::get_memory_files "$QSYS_SIMDIR"]]
...
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set design_files [dict merge $design_files [qsfp_xcvr_test::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set files [concat $files [qsfp_xcvr_test::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set libraries [dict create]
source $QSYS_SIMDIR/common/vcsmx_files.tcl
set libraries [dict merge $libraries [qsfp_xcvr_test::get_dpi_libraries "$QSYS_SIMDIR"]]
