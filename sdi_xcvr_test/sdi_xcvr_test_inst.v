	sdi_xcvr_test u0 (
		...
		.pll_status_interconnect_0_pll_locked_pll_locked (_connected_to_pll_status_interconnect_0_pll_locked_pll_locked_), //   input,   width = 1, pll_status_interconnect_0_pll_locked.pll_locked
