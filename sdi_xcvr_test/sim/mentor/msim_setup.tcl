...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "sdi_xcvr_test.sdi_xcvr_test"
}
...
append ELAB_OPTIONS [subst [sdi_xcvr_test::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [sdi_xcvr_test::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set normalized_src [sdi_xcvr_test::normalize_path "$file"]
  set normalized_dest [sdi_xcvr_test::normalize_path "$dest_file"]
...
set design_libraries [dict merge $design_libraries [sdi_xcvr_test::get_design_libraries]]
...
alias com {
  ...
  set design_files [dict merge [sdi_xcvr_test::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
  set common_design_files [dict values $design_files]
  foreach file $common_design_files {
    eval $file
  }
  set design_files [list]
  set design_files [concat $design_files [sdi_xcvr_test::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
