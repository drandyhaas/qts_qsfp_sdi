...
//   output_name:        alt_sld_fab_0_demultiplexer_1930_noh4s6a
//   use_packets:        false
//   use_empty:          0
//   empty_width:        0
//   data_width:         1
...
module alt_sld_fab_0_demultiplexer_1930_noh4s6a #(
...
// ---------------------------------------------------------------------
alt_sld_fab_0_demultiplexer_1930_noh4s6a_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH( 1 + 1 )) inpipe
 ( .clk      (clk ),
   .reset_n  (reset_n  ),
   .in_ready (in_ready_wire ),
   .in_valid (in_valid ),
...
always @* begin
   ...
   // ---------------------------------------------------------------------
alt_sld_fab_0_demultiplexer_1930_noh4s6a_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH(1)) outpipe0
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs0_ready ),
    .in_valid   (rhs0_valid),
...
alt_sld_fab_0_demultiplexer_1930_noh4s6a_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH(1)) outpipe1
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs1_ready ),
    .in_valid   (rhs1_valid),
...
//  --------------------------------------------------------------------------------
module alt_sld_fab_0_demultiplexer_1930_noh4s6a_1stage_pipeline
