...
//   output_name:        alt_sld_fab_0_demultiplexer_1930_sn3ldsy
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         8
...
module alt_sld_fab_0_demultiplexer_1930_sn3ldsy #(
...
// ---------------------------------------------------------------------
alt_sld_fab_0_demultiplexer_1930_sn3ldsy_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH( 10 + 1 )) inpipe
 ( .clk      (clk ),
   .reset_n  (reset_n  ),
   .in_ready (in_ready_wire ),
   .in_valid (in_valid ),
...
always @* begin
   ...
   // ---------------------------------------------------------------------
alt_sld_fab_0_demultiplexer_1930_sn3ldsy_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH(10)) outpipe0
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs0_ready ),
    .in_valid   (rhs0_valid),
...
alt_sld_fab_0_demultiplexer_1930_sn3ldsy_1stage_pipeline #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH(10)) outpipe1
  ( .clk        (clk ),
    .reset_n    (reset_n  ),
    .in_ready   (rhs1_ready ),
    .in_valid   (rhs1_valid),
...
//  --------------------------------------------------------------------------------
module alt_sld_fab_0_demultiplexer_1930_sn3ldsy_1stage_pipeline
