...
//   output_name:        alt_sld_fab_0_multiplexer_1930_ulkyqry
//   use_packets:        true
//   use_empty:          0
//   empty_width:        0
//   data_width:         8
...
module alt_sld_fab_0_multiplexer_1930_ulkyqry #( parameter SYNC_RESET =0 )
(     
// Interface: out
...
endcase // case (select)
   ...
   alt_sld_fab_0_multiplexer_1930_ulkyqry_1stage_pipeline  #( .SYNC_RESET(SYNC_RESET), .PAYLOAD_WIDTH( 10 + 1 ) ) outpipe
              ( .clk      (clk ),
                .reset_n  (reset_n  ),
...
//  --------------------------------------------------------------------------------
module alt_sld_fab_0_multiplexer_1930_ulkyqry_1stage_pipeline
  #( parameter SYNC_RESET =0 , PAYLOAD_WIDTH = 8 )
    (    input                             clk,
         input                          reset_n,
         output reg                     in_ready,
         input                          in_valid,
